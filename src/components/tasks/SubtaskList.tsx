...
export function SubtaskList({ subtasks, onToggle, onAdd, onDelete, onUpdateText }: SubtaskListProps) {
    ...
    <div className="px-6 pb-6">
      ...
      <div className="space-y-0.5 mb-3">
        {subtasks.map((subtask) => (
          <div key={subtask.id} className="flex items-center gap-3 group py-2 -mx-2 px-2 rounded-md hover:bg-muted/50">
            <button
